 ...
 * @author Admin
 */
public class productManageFilter implements Filter {
    ...
    public productManageFilter() {
    }

    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("productManageFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("productManageFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("productManageFilter:doFilter()");
        }
        ...
        try {
            // Custom session and role-based logic
...
//            HttpSession session = req.getSession(false);
            HttpSession session = req.getSession(); // assuming user have authorization for the sake of testing
            if (session != null) {
...
//                int roleId = (Integer) session.getAttribute("roleId");
                ...
                res.sendRedirect("index.html"); // Redirect to login if no session
            }
        } catch (Throwable t) {
            problem = t;
            t.printStackTrace();
        ...
        // If there was a problem, rethrow it if it is a known type
        if (problem != null) {
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("productManageFilter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("productManageFilter()");
        }
        StringBuffer sb = new StringBuffer("productManageFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("productManageFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("productManageFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("productManageFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("productManageFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("productManageFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
