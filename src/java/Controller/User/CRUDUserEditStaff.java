 ...
 * @author ASUS
 */
public class CRUDUserEditStaff extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CRUDUserEditStaff</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CRUDUserEditStaff at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        User staff = db.getUserById(staffID);
        request.setAttribute("user", staff);
        
        request.getRequestDispatcher("/View/UserManage/EditStaff.jsp").forward(request, response);
    } 
