...
public class DeleteCategoryServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        // Attempt to delete the category using CategoryDAO
        boolean isDeleted = CategoryDAO.getInstance().deleteCategory(categoryID);

        // Set the message to be displayed based on deletion success or failure
        if (isDeleted) {
        ...
        // Redirect back to the category list page with a message
